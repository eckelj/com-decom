...
unsigned_fulfillment_dict = {
    ...
    'amount': [ {"Name": "amount", "Amount": 500},]

output = {
    
    'amount': '2400', # must not be <= 0, 
    # composities and attributes must not be < 0, but can be 0 for transactions/transfers
    'composit': [ ]
    'attributes' : [ {"Name": "CarbonEmission", "Amount": 500}, 
     {"Name": "hazardous", "Amount": 500}, 
     {"Name": "CarbonEmission", "Amount": 500}, 
     {"Name": "CarbonEmission", "Amount": 500}, 
     {"Name": "CarbonEmission", "Amount": 500}, 
     {"Name": "CarbonEmission", "Amount": 500}, 
     ],
...
##returned_creation_tx = plntmnt.transactions.send_async(token_creation_tx)
